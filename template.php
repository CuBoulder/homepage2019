...
function homepage2019_preprocess_html(&$vars) {
  ...
  $banner_color = theme_get_setting('banner_color', 'homepage2019') ? theme_get_setting('banner_color', 'homepage2019') : 'black';
  //$banner_color = 'light';
  $vars['classes_array'][]='banner-' . $banner_color;
  $layout = theme_get_setting('layout_style', 'homepage2019') ? theme_get_setting('layout_style', 'homepage2019') : 'layout-wide';
