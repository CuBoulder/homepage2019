  ...
  <div class="page <?php print $classes; ?>">
    ...
    <div id="mobile-navigation-wrapper" class="section no-underline">
      <div id="mobile-navigation">
        <!-- Mobile search -->
        <div id="mobile-search" class="background-black">
          <?php print render($search_mobile); ?>
        </div>
        <!-- Mobile menu -->
    ...
    <div class="page-content">
      ...
      <div id="main-content-wrapper" class="section main-content-wrapper">
        <div id="main" class="clearfix">
          ...
          <div class="container">
            <!-- TITLE -->
            <div class="<?php if (isset($title_image) && !drupal_is_front_page()) { print 'element-invisible'; }  ?>">
